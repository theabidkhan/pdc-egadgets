...
const instantiateChaincode = async function(peers, channelName, chaincodeName, chaincodeVersion, functionName, chaincodeType, args, username, org_name, instantiateType, pdc) {
	...
	try {
		...
		if (pdc) {
			...
			console.log('Instantiate Request Parameters With Collection Data: ');
			console.log(request);
		} else {
            request = {
                targets : peers,
