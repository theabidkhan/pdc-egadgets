...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	let message = await instantiate.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, args, req.username, req.orgname, instantiateType, pdc);
	res.send(message);
});
